...
class ControlPanel(QWidget):
    ...
    open_surface_layer_physics = pyqtSignal()
    open_boundary_layer_schemes = pyqtSignal()
    open_high_order_time_stepping = pyqtSignal()  # New signal for HOTS window
    air_sea_interaction = pyqtSignal()
    cloud_microphysics = pyqtSignal()
    oceanic_eddies = pyqtSignal()
    ...
    def create_control_buttons(self, layout):
        ...
        button_layout1.setContentsMargins(0, 10, 0, 0)
        ...
        self.slp_button = QPushButton("SLP")
        self.slp_button.setFont(QFont("Consolas", 10, QFont.Bold))
        self.slp_button.setSizePolicy(QSizePolicy.Expanding, QSizePolicy.Fixed)
        self.slp_button.setMinimumHeight(30)
        self.slp_button.setStyleSheet("""
            QPushButton {
                background-color: #008080;
                color: #FFFFFF;
                border: 2px outset #808080;
        ...
        """)
        self.slp_button.clicked.connect(self.open_surface_layer_physics.emit)
        self.slp_button.setEnabled(False)
        
        self.bls_button = QPushButton("BLS")
        self.bls_button.setFont(QFont("Consolas", 10, QFont.Bold))
        self.bls_button.setSizePolicy(QSizePolicy.Expanding, QSizePolicy.Fixed)
        self.bls_button.setMinimumHeight(30)
        self.bls_button.setStyleSheet("""
            QPushButton {
                background-color: #008080;
                color: #FFFFFF;
                border: 2px outset #808080;
        ...
        """)
        self.bls_button.clicked.connect(self.open_boundary_layer_schemes.emit)
        self.bls_button.setEnabled(False)
        ...
        button_layout1.addWidget(self.turbulent_mixing_button)
        button_layout1.addWidget(self.slp_button)
        
        # Second row for BLS and HOTS buttons
        button_layout2 = QHBoxLayout()
        button_layout2.setContentsMargins(0, 5, 0, 0)
        button_layout2.setSpacing(8)
        
        button_layout2.addWidget(self.bls_button)
        
        self.hots_button = QPushButton("HOTS")
        self.hots_button.setFont(QFont("Consolas", 10, QFont.Bold))
        self.hots_button.setSizePolicy(QSizePolicy.Expanding, QSizePolicy.Fixed)
        self.hots_button.setMinimumHeight(30)
        self.hots_button.setStyleSheet("""
            QPushButton {
                background-color: #008080;
                color: #FFFFFF;
                border: 2px outset #808080;
        ...
        """)
        self.hots_button.clicked.connect(self.open_high_order_time_stepping.emit)
        self.hots_button.setEnabled(False)
        
        button_layout2.addWidget(self.hots_button)
        button_layout2.addStretch()  # Align BLS and HOTS buttons to the left

        self.air_sea_button = QPushButton("Air Sea Interaction")
        self.air_sea_button.setFont(QFont("Consolas", 10, QFont.Bold))
        self.air_sea_button.clicked.connect(self.air_sea_interaction.emit)
        button_layout2.addWidget(self.air_sea_button)

        self.cloud_microphysics_button = QPushButton("Cloud Microphysics")
        self.cloud_microphysics_button.setFont(QFont("Consolas", 10, QFont.Bold))
        self.cloud_microphysics_button.clicked.connect(self.cloud_microphysics.emit)
        button_layout2.addWidget(self.cloud_microphysics_button)

        self.oceanic_eddies_button = QPushButton("Oceanic Eddies")
        self.oceanic_eddies_button.setFont(QFont("Consolas", 10, QFont.Bold))
        self.oceanic_eddies_button.clicked.connect(self.oceanic_eddies.emit)
        button_layout2.addWidget(self.oceanic_eddies_button)
        
        layout.addLayout(button_layout1)
        layout.addLayout(button_layout2)

    def on_oceanic_eddies_clicked(self):  # MODIFIED: Added wrapper method for debugging
        logging.debug("Oceanic Eddies button clicked")
        print("Oceanic Eddies button clicked")  # MODIFIED: Added console output
        self.oceanic_eddies.emit()
    ...
    def emit_simulation_params(self):
        ...
        try:
            ...
            self.slp_button.setEnabled(True)
            self.bls_button.setEnabled(True)
            self.hots_button.setEnabled(True)
