...
class ControlPanel(QWidget):
    ...
    open_boundary_layer_schemes = pyqtSignal()  # New signal for BLS window
    ...
    def create_control_buttons(self, layout):
        ...
        button_layout2.addStretch()  # Add stretch to align BLS button to the left
