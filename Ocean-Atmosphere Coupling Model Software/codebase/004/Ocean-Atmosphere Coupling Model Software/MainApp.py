...
class MainApp(QMainWindow):
    def __init__(self):
        ...
        try:
            ...
            console_scroll.setMinimumHeight(200)  # Set a reasonable minimum height
            console_scroll.setMaximumHeight(300)  # Limit height to save space for future buttons
            
            # Add control panel and console to left layout, control panel at the top
            left_layout.addWidget(self.control_panel)
            left_layout.addWidget(console_scroll)
            left_layout.addStretch()  # Push content to the top, leaving space below for future buttons
            ...
            self.model = None
            self.timer = QTimer()
            self.timer.timeout.connect(self.update_simulation)  # Connect to update_simulation method
            self.current_step = 0
            self.turbulent_mixing_window = None  # Store turbulent mixing window instance
