...
class ControlPanel(QWidget):
    ...
    def __init__(self):
        ...
        try:
            ...
            # Input fields with adjusted defaults
            self.inputs = {}
            params = [
                ("Initial Ocean Temp (K)", "300.0"),
                ("Initial Atmosphere Temp (K)", "295.0"),
                ("Coupling Coefficient (W/m²/K)", "5.0"),  # Legacy, unused
    ...
    def emit_simulation_params(self):
        ...
        try:
            ...
            if params["drag_coeff"] <= 0 or params["wind_speed"] < 0 or \
               ...
               params["mixing_coeff"] <= 0 or params["co2_transfer_coeff"] <= 0:
                raise ValueError("Drag coefficient, wind speed, precipitation, evaporation, "
                               "mixing coefficient, and CO2 transfer velocity must be non-negative.")
